...
/*   Updated: 2018/07/10 19:35:37 by kmykhail         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
GameObject::~GameObject() {
    ...
    if (_pl.getStatusGame())
        mvprintw(_y_map / 2, _x_map / 2, "FUCK YOU SCUM");
...
int GameObject::initPlayer() {
    _pl.setCoorY((_y_map + 30) - _y_map);
    _pl.setCoorX_2(_x_map / 2 - 1);
    _pl.setCoorX(_x_map / 2 );
    _pl.setCoorX_3(_x_map / 2 + 1);
    attron(COLOR_PAIR(2));
    attron(A_BOLD);
